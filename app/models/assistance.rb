class Assistance < ActiveRecord::Base
 ...
 validates :excepcion, inclusion:  { in: [false],:message => "No puede ser marcada si trabajador si asistio"  }, unless: :asistio? 
 validates :horas, inclusion:  { in: [0],:message => "No pueden ser agregadas si trabajador no asistio"  }, if: :asistio? , allow_nil: true
