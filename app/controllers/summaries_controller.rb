class SummariesController < ApplicationController
  ...
  # POST /summaries.json
  def create
    if params[:summary][:worker_ids]
      params[:summary][:worker_ids] = params[:summary][:worker_ids].map { |k, v| k}
     else
     params[:summary][:worker_ids] = [] 
    end
  ...
  private
    ...
    def summary_params
      params.require(:summary).permit(:fecha, :resumen, :worker_id)
    end
end
