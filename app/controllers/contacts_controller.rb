class ContactsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @contact.update(contact_params)
        format.html { redirect_to @contact, notice: 'Contacto eliminado con exito' }
  ...
  def destroy
    @contact.destroy
    respond_to do |format|
      format.html { redirect_to contacts_url, notice: 'Contacto eliminado con exito' }
  ...
  private
    ...
    def contact_params
      params.require(:contact).permit(:nombre, :rut, :fono, :email, :comentario)
    end
end
