...
class SummariesControllerTest < ActionController::TestCase
  ...
  test "should create summary" do
    assert_difference('Summary.count') do
      post :create, summary: { fecha: @summary.fecha, resumen: @summary.resumen, worker_id: @summary.worker_id }
    end
  ...
  test "should update summary" do
    patch :update, id: @summary, summary: { fecha: @summary.fecha, resumen: @summary.resumen, worker_id: @summary.worker_id }
    assert_redirected_to summary_path(assigns(:summary))
  end
